...
function login() {
  ...
  if (username == "" || password == "") {
    displayErrorToast("Following fields can't be empty");
    return;
  }
  ...
  axios({
    ...
    .catch(function (err) {
      displayErrorToast("Entered credentials are wrong");
...
function addTask() {
  ...
  if (task == "") {
    displayErrorToast("Todo can't be empty");
    return;
  }
  ...
  axios({
    ...
    .then(function ({ data, status }) {
      displaySuccessToast("Successfully added todo");
      document.getElementById("inputTask").value = "";
      getTasks();
    })
    .catch(function (err) {
      displayErrorToast("Unable to add todo");
    });
}
...
export function deleteTask(id) {
  ...
  axios({
    ...
    .catch(function (err) {
      displayErrorToast("Unable to delete todo");
    });
}
...
export function updateTask(id) {
  ...
  if (newTask == "") {
    displayErrorToast("Todo can't be blank");
    return;
  }
  ...
  axios({
    ...
    .catch(function (err) {
      displayErrorToast("Unable to update todo. ");
    });
}
